...
const Register = () => {
  ...
  return (
    <div className='px-8 w-full lg:w-[70%]'>
      {!enableVerify &&
      <>
      <p className='text-3xl font-bold pb-4 pt-4'>Sing Up</p>
      <GoogleSignIn />
      ...
      <div className='pt-4'>
        <form onSubmit={onSubmit} autoComplete='off'>
          ...
          <button className='border w-full rounded-lg h-[48px] mb-4 bg-black text-white mt-4 hover:opacity-80' >Sing up</button>
        </form>
