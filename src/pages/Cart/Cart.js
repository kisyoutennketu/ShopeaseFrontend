    ...
    <div className='p-4' >
        ...
        <div className='flex justify-between bg-gray-200 p-8'>
            <div>
                ...
                <p className='text-sm text-gray-600'>Enter your coupon</p>
                <form>
                    <input type='text' className='w-[120px] h-[48px] mt-2 border-gray-500 rounded-lg p-2 hover:outline-none' placeholder='Enter code' />
                    <button className='w-[80px] h-[48px] bg-black border rounded-lg text-white ' >Apply</button>
                </form>
            </div>
            <div className='mr-20 pr-8'>
                <dvi className='flex gap-8 text-lg'>
